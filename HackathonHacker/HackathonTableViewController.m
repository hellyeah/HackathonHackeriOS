...
- (void)viewDidLoad
{
    ...
    self.hackathons = [NSArray arrayWithObjects:@"MHacks", @"PennApps", @"HackTheNorth", @"YHacks", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 1:
            // Configure the cell...
            cell.textLabel.text = [self.hackathons1 objectAtIndex:indexPath.row];
            break;
        case 2:
            // Configure the cell...
            cell.textLabel.text = [self.hackathons2 objectAtIndex:indexPath.row];
            break;
        case 3:
            // Configure the cell...
            cell.textLabel.text = [self.hackathons3 objectAtIndex:indexPath.row];
            break;
        default:
            break;
    }
